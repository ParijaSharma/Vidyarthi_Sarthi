    ...
    return (
        <nav className="mx-6 pt-6 px-8 py-4 rounded-2xl flex justify-between items-center ">
            ...
            <div className="flex gap-3">
                <button onClick={onOpenAuth} className="text-sm text-slate-300 hover:text-white transition-colors">Sign in</button>
                <button onClick={onOpenAuth} className="text-sm text-slate-900 bg-yellow-400 px-4 py-2 rounded-2xl hover:bg-yellow-500 transition-colors">Register</button>
            </div>
        </nav>
    );
}
